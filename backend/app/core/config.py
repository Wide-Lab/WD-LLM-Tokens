...
class Config(BaseSettings):
    ...
    do browser. Vazia = só a sessão abre os `GET`."""
    ...
    CHAVE_ADMIN: str = ""
    """A chave que cadastra preço (`POST /v1/precos`).

    Separada da de leitura porque a de leitura vive no browser (ver `docs/api.md`), e uma chave
    exposta no cliente não pode ser a que reescreve a tabela de onde sai todo o custo."""
