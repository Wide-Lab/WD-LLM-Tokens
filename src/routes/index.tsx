...
function useMetricas(params: Record<string, string | undefined>) {
  ...
  return useQuery({
    queryKey: ["metricas", config.baseUrl, config.apiKey, params],
    queryFn: () => apiFetch<MetricaBucket[]>(config, "/v1/metricas", params),
...
function Overview() {
  ...
  if (!isConfigured) return <><GlobalFilters /><div className="mt-6"><NeedsConfig /></div></>;
